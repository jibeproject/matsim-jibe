...
//        fixed.add("g_walk_vgvi");
//        fixed.remove("g_bike_stressLink");
//        fixed.remove("g_bike_grad");
       // fixed.remove("g_bike_vgvi");
//        fixed.remove("g_walk_stressJct");
//        fixed.remove("g_walk_vgvi");
        return fixed;
    }
    ...
    UtilityFunction[] utility() {
        ...
        builder.put(3,(c,i) -> sociodemographicUtility(c,i,"bike") + beta(c,"b_bike_cost") * (value(i,"bike_time") +
        ...
        builder.put(4,(c,i) -> sociodemographicUtility(c,i,"walk") + beta(c,"b_walk_cost") * (value(i,"walk_time") +
    ...
    Map<String, UtilityFunction[]> derivatives() {
        ...
        // Bike
        builder.putAt("b_bike_cost",(c,i)->value(i,"bike_time") +
                beta(c,"g_bike_grad") * value(i,"bike_grad") +
                beta(c,"g_bike_vgvi") * value(i,"bike_vgvi") +
                beta(c,"g_bike_stressLink") * value(i,"bike_stressLink") +
                beta(c,"g_bike_stressJct") * value(i,"bike_stressJct"),3);
        ...
        // Walk
        builder.putAt("b_walk_cost",(c,i)->value(i,"walk_time") +
                beta(c,"g_walk_grad") * value(i,"walk_grad") +
                beta(c,"g_walk_vgvi") * value(i,"walk_vgvi") +
                beta(c,"g_walk_stressLink") * value(i,"walk_stressLink") +
                beta(c,"g_walk_stressJct") * value(i,"walk_stressJct"),4);
