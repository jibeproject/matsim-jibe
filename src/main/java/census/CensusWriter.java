...
public class CensusWriter {
    ...
    public static void write(Set<Trip> trips, String filePath, Map<String, List<String>> attributes) {
        ...
        for (Trip trip : trips) {
            ...
            out.println(createRow(trip,allAttributes,attributes));
        }
        out.close();
    ...
    private static String createRow(Trip trip, Set<String> allAttributes, Map<String, List<String>> attributes) {
