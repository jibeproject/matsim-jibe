...
public class JibeCycleRoute implements TravelDisutility {
    ...
    public double getLinkTravelDisutility(Link link, double time, Person person, Vehicle vehicle) {
        ...
        double attractiveness = CustomBicycleUtils.getAttractiveness(link);
        disutility += marinalCostAttractiveness_m * attractiveness * distance;

        // Stress factors
        double stress = CustomBicycleUtils.getStress(link);
        disutility += marginalCostStress_m * stress * distance;

        // Junction stress factor
        double junctionStress = CustomBicycleUtils.getJunctionStress(link);
    ...
    public double getJunctionComponent(Link link) {
        double jctStress = CustomBicycleUtils.getJunctionStress(link);
